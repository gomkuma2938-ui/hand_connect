    ...
    this.listContainer.innerHTML = comments.map(c => {
      ...
      return `
        <div class="comment-item" id="item-${c.id}">
          ...
          <div id="action-area-${c.id}" class="edit-field-container" style="display:none;">
