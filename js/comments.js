...
displayComments(comments) {
        // 1. 댓글필드 상단 소제목 (입력 폼과 리스트 사이)
        let html = `<h3 class="comments-title">기도 동참하기🙏</h3>`;
            ...
            return `
                <div class="comment-item">
                    ...
                    <div id="action-area-${safeId}" class="edit-field-container" style="display:none;">
                        ...
                        <!-- 7. 얼럿 대신 아래에 띄울 경고 문구 영역 -->
                        <div id="action-msg-${safeId}" class="error-msg" style="display:none; font-size:11px; color:red; margin-top:5px;"></div>
                    </div>
                </div>
            `;
        }).join('');
